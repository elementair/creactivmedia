  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="nuevo-blog.php">Nuevo Blog</a></li>
        <?php
...
<div class="jumbotron portada">
  <div class="container">
       <div class="row">
         ...
         <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            ...
            ?>
                  ...
                  <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                  <span class="sr-only">Error:</span>
                    Seleccione una imagen para el articulo del blog. 1024px (an) x 512px (al)
                  </div>
            <?php 
            }
            ?>
   ...
   <form action="procesa-nuevo-blog.php" method="POST" class="form-horizontal" role="form" id="form" name="form" enctype="multipart/form-data">
      ...
      <div class="container-fluid">
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                  <input type="text" name="titulo" placeholder="Titulo del blog | 70 caracteres máx." id="titulo" class="form-control" required="required" value="<?php echo (isset($_SESSION['DatBlog'][0]))? trim($_SESSION['DatBlog'][0]) : '' ?>" title="" maxlength="70">
              ...
              <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    <textarea name="desc-corta" placeholder="Descripción breve del blog 150 caracteres máx." id="subtitulo" class="form-control" rows="3" required="required" maxlength="150"><?php 
                    if(isset($_SESSION['DatBlog'][1])){
                        echo $_SESSION['DatBlog'][1];
                    }
                    ?></textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                  <input type="text" name="tags" placeholder="Agregar Keywords 10 máx. separadas por coma." id="input" class="form-control" value="<?php echo (isset($_SESSION['DatBlog'][2]))? trim($_SESSION['DatBlog'][2]) : '' ?>" required="required" title="">
                </div>
              </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                  <input type="text" name="" id="" class="form-control" value="<?php echo $fechaAct; ?>" required="required" pattern="" title=""  disabled>
                </div>
              </div>
          ...
          ?>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                  <select name="status" id="input" class="form-control" required="required">
                    <option value="1" <?php if(isset($_SESSION['DatBlog'][4])){ if($_SESSION['DatBlog'][4]==1) echo "selected='selected'"; else ''; }?> >Publicar</option>
                    <option value="0" <?php if(isset($_SESSION['DatBlog'][4])){ if($_SESSION['DatBlog'][4]==0) echo "selected='selected'"; else ''; }?> >Guardar sin publicar </option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                  <input type="text" name="" id="" class="form-control" value="<?php echo ucwords($_SESSION['nombre']); ?>" required="required" pattern="" title="" disabled>
                  <input type="hidden" name="autor" id="" class="form-control" value="<?php echo ucwords($_SESSION['id']); ?>">
                </div>
              </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <textarea name="art" id="_articulo" class="ckeditor" rows="50" cols="50"><?php 
                    if(isset($_SESSION['DatBlog'][5])){
                        echo $_SESSION['DatBlog'][5];
                    }
                    ?></textarea>
                      </div>
                    </div>
