              ...
              <?php
                  ...
                  //$variable = ($haceFrio) ? "Hace frío" : "No hace frío";
                   echo "<br><a href='usuarios.php' class='btn btn-default' role='button'>Regresar</a><br>";
                    ...
                    echo "
                    <form action='procesa-nuevo-usuario.php' method='POST' enctype='multipart/form-data' role='form'>
                        ...
                        <input type='text' class='form-control' id='' name='user' placeholder='Ej. nombre_apellido'>
                        </div>


                        <div class='form-group'>
                        <label for=''>Password</label>
                        <input type='password' class='form-control' id='' name='pass1' placeholder='Password'>
                        </div>

                        <div class='form-group'>
                        <label for=''>Password</label>
                        <input type='password' class='form-control' id='' name='pass2' placeholder='Escribe de nuevo el Password'>
                        </div>


                        <div class='form-group'>
                        <label for=''>Nombre</label>
                        <input type='text' class='form-control' id='' name='nombre' placeholder='Nombre Apellido'>
                        </div>

                        <div class='form-group'>
                        <label for=''>Puesto</label>
                        <input type='text' class='form-control' id='' name='puesto' placeholder='Puesto'>
                        </div>";
                    ...
                    echo "<option value='1'>Editor / Administrador</option>";
                    echo "<option value='2' selected>Editor</option>";
                    ...
                    echo "</select>
                        ...
                        <textarea id='input' class='form-control' name='bio' rows='3' required='required'></textarea>
                        </div>


                        <div class='form-group'>
                        <label for=''>Playlist spotify (clic derecho en playslit, compartir -> copiar URL)</label>
                        <input type='text' class='form-control' id='' name='playlist' placeholder='spotify:user:11123774596:playlist:4x87NavErxtFzlbe1LwZPZ'>
                        </div>
