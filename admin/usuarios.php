 ...
 <?php
        ...
        <div class="table-responsive">
          ...
          <table class="table table-hover">
            ...
            <?php
                if ($sql = mysqli_query($con,"SELECT id, user, nombre, activo, permiso, img, puesto, bio, playlist, fecha_alta FROM user ORDER BY id DESC")) {
                    ...
                    echo "<td colspan='7'>No existen registros disponibles</td>";
                          ...
                          while($row0 = mysqli_fetch_assoc($sql)) {
                            ...
                            echo "<tr>";
                              echo "<td>".$row0["user"]."</td><td><img src='../image/img-profile/".$row0["img"].".jpg' class='img-circle' width='100px' height='100px'></td><td>".$row0["nombre"]."</td><td>".$row0["puesto"]."</td><td>".$row0["bio"]."</td><td><a href='editar-usuario.php?id=".$row0["id"]."' class='btn btn-default' role='button'>Editar</a></td>";                              
                            echo "</tr>";
                          }
