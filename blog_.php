  ...
  !function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?
    ...
    t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,
      ...
      <noscript><img height="1" width="1" style="display:none"
        ...
        <div class="portada-destacado hidden-xs" style="background-image: url('http://via.placeholder.com/1920x800');">
          <div class="row">
            <div class="destacado" style="background-image:url('http://via.placeholder.com/685x800');">
            </div>
            <div class="extracto hidden-xs hidden-sm">
              <div class="texto">
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>
              </div>
              <img class="autor_img" src="http://via.placeholder.com/200x200" alt="">
              <button type="button" class="ir_nota" name="button">Ver más</button>
            </div>
          </div>
        </div>
        <div class="container-fluid">
          <div class="btn-search-blog">
            ...
            <button type="button" class="fas fa-search" id="buscar" acceskey="intro"></button>
          </div><!-- /input-group -->
          <div class="cont-autor">
            ...
            if ($sqlU = mysqli_query($con, "SELECT id, user, nombre, activo, img, puesto FROM user WHERE NOT id=1 ORDER BY id DESC")) {
              ...
              echo "<div id='autores' class='owl-carousel'>";
          ...
          <div class="wrapper-content">
                    ...
                    ")) {
                      ...
                      if(mysqli_num_rows($sql2) == 0){
                        ...
                        while($row = mysqli_fetch_assoc($sql2)) {
                          ...
                          echo "<div class='item'>
                          <img src='blog/".$row["id_entrada"].".jpg' class='thumbnail-blog'  alt='' />
                          <a href='blog_?id=".$row["id_entrada"]."' class='link' id='' ></a>
                          </div>";
                        }
                        ...
                        if(mysqli_num_rows($sql3) == 0){
                          ...
                          while($row = mysqli_fetch_assoc($sql3)) {
                            ...
                            */
                            ...
                            echo "<div class='item'>
                            <img src='blog/".$row["id_entrada"].".jpg' class='thumbnail-blog'  alt='' />
                            <a href='blog_?id=".$row["id_entrada"]."' class='' id='' ></a>
                            </div>";
                          }
                  ...
                  WHERE B.activo=1 ORDER BY B.fecha DESC LIMIT 1,500")) {
                    ...
                    if(mysqli_num_rows($sql) == 0){
                      ...
                      while($row0 = mysqli_fetch_assoc($sql)) {
                        ...
                        $post=$row0["intro"];
                        echo "<div class='item'>
                        <img src='http://via.placeholder.com/290x290' class='thumbnail-blog'  alt='' />
                        <a href='blog_?id=".$row0["id_entrada"]."' class='ver_mas' id='' >Ver más</a>
                        </div>";
                      }
                      echo "</div>";
                    }
            ...
            <button class="mas_blogs">Más blogs</button>
          </div>
        </div>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            LEFT OUTER JOIN `user` AS U ON U.id = B.id_autor WHERE id_entrada='".$_GET["id"]."' AND B.activo=1")) {
              ...
              echo "<div class='col-xs-12 portada'>";
              ...
              while($row = mysqli_fetch_assoc($sqlDes)) {
                ...
                echo "<h2 class='blog_title'><span class='title_bold'>5</span> tendencias de <span class='title_bold'>Marketing</span> en <span class='title_bold'>Instagram</span> a mitad del <span class='title_bold'>2018</span></h2>
                <br/><p class='fecha'>".$row["fecha"]."</p><br/></div>";

                echo "</div></div><div class='row'>
                <div class='col-xs-12 colorGradient'></div>
                <div class='col-xs-12 colorBlack'>";

                echo "<div class='user'>";
                echo "<a href='blog_?autor=".$row["id_autor"]."'><img src='image/img-profile/".$row["foto"].".jpg' class='autor_min' alt=''></a>
                <h4 class='autor_name'>".$row["nombre"]."</h4>
                <p class='autor_puesto'>".$row["puesto"]."</p>
                ";
                echo "</div>";
                echo "<div id='cat' class='hidden-xs hidden-sm'><h3>Categorías <i id='catBars' class='fas fa-bars'></i></h3>";
            ...
            LEFT OUTER JOIN `user` AS U ON U.id = B.id_autor WHERE id_entrada='".$_GET["id"]."' AND B.activo=1 ")) {
              ...
              if(mysqli_num_rows($sql2) == 0){
                ...
                while($row1 = mysqli_fetch_assoc($sql2)) {
                  ...
                  echo "<p class=''>".$row1["articulo"]."</p>";
                  ?>
                  </div>
                  <!-- plugin redes-->
                  <div class="btnComp">
                  <button type='button' class='share'>Compartir</button>
                  <ul class="rrssb-buttons">
                  <li class="rrssb-email">
                  <!-- Replace subject with your message using URL Endocding: http://meyerweb.com/eric/tools/dencoder/ -->
                  <a class="popup" href="mailto:?subject=<?php echo urldecode($row1["title"]); ?>&amp;body=http://www.creactivmedia.com.mx/blog_?id=<?php echo $_GET["id"];  ?> ">
                  ...
                  <span class="rrssb-text hidden-xs">email</span>
                  </a>
                  </li>
                  ...
                  <span class="rrssb-text hidden-xs">facebook</span>
                  </a>
                  </li>
                  ...
                  <a href="http://twitter.com/share?via=CreActivMedia" data-via="CreActivMedia" class="popup">
                  <span class="rrssb-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28"><path d="M24.253 8.756C24.69 17.08 18.297 24.182 9.97 24.62a15.093 15.093 0 0 1-8.86-2.32c2.702.18 5.375-.648 7.507-2.32a5.417 5.417 0 0 1-4.49-3.64c.802.13 1.62.077 2.4-.154a5.416 5.416 0 0 1-4.412-5.11 5.43 5.43 0 0 0 2.168.387A5.416 5.416 0 0 1 2.89 4.498a15.09 15.09 0 0 0 10.913 5.573 5.185 5.185 0 0 1 3.434-6.48 5.18 5.18 0 0 1 5.546 1.682 9.076 9.076 0 0 0 3.33-1.317 5.038 5.038 0 0 1-2.4 2.942 9.068 9.068 0 0 0 3.02-.85 5.05 5.05 0 0 1-2.48 2.71z"/></svg>
                  </span>

                  <span class="rrssb-text hidden-xs">twitter</span>
                  </a>
                  ...
                  <span class="rrssb-text hidden-xs">google+</span>
                  </a>
                  </li>
                  ...
                  <span class="rrssb-text hidden-xs">print</span>
                  </a>
                  </li>
                  ...
                  <span class="rrssb-text hidden-xs">Whatsapp</span>
                  </a>
                  </li>
                  </ul>
                  </div>
            ...
            if ($sql3 = mysqli_query($con,"SELECT id, nombre, img AS foto, puesto FROM user")) {
              echo "<div id='autores_detalle' class='owl-carousel'>";
              while($row = mysqli_fetch_assoc($sql3)) {
                echo "<div class='autor-item'><a href='blog_?autor=".$row["id"]."'><img src='image/img-profile/".$row["foto"].".jpg' class='img-circle img-autor' width='100px' height='100px' alt=''></a>
                <p class='p-autor'>".$row["nombre"]."</p>
                </div>";
              }
              echo "</div>";
            }else{
