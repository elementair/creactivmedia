<div id="fpd-order-panel">
	<div id="fpd-order-designer-wrapper">
		...
		<div id="fpd-order-designer-wrapper">
			<div id="fpd-order-designer" class="fpd-views-inside-left fpd-container fpd-top-actions-centered fpd-topbar fpd-off-canvas-left"></div>
		</div>
				...
				<div data-id="export" class="current radykal-columns-two">
					...
					<div>
						<table class="form-table">
							...
							<tr>
								<th>
									<?php _e('Include Text Summary', 'radykal' ); ?><br />
								</th>
								<td>
									<label>
