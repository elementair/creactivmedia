					...
					if( $type == 'text' ) {
						...
						switch($key) {
							...
							case 'textNumberPlaceholder':
								if($value === 'text')
									$params_object .= '"textPlaceholder":true,';
								else if($value === 'number')
									if( isset($parameters['numberPlaceholderMin']) && isset($parameters['numberPlaceholderMax']) ) {
										$params_object .= '"numberPlaceholder":['.$parameters['numberPlaceholderMin'].', '.$parameters['numberPlaceholderMax'].'],';
									}
									else
										$params_object .= '"numberPlaceholder":true,';
							break;
						}
					}
