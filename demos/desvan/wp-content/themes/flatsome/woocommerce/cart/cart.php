	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions clear">
				...
				<input type="submit" class="button primary mt-0 pull-left small" name="update_cart" value="<?php esc_attr_e( 'Actualizar', 'woocommerce' ); ?>" />
	...
	<div class="cart-sidebar">
		...
		<form class="checkout_coupon pt-half mb-0" method="post">
			...
			<h3 class="widget-title"><?php echo get_flatsome_icon('icon-tag'); ?> <?php _e( 'Coupon', 'woocommerce' ); ?></h3>
				<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> <input type="submit" class="primary expand" name="apply_coupon" value="<?php esc_attr_e( 'APLICAR CUPÓN', 'woocommerce' ); ?>" />
