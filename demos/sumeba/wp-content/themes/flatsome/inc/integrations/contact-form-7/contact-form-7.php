...
function flatsome_contact_form_presets($args){
    ...
    <p style="font-size: 1.5em; background-color: rgba(0, 130, 0, 0.09); padding:15px;">
      Copie y pegue un formulario preestablecido en la pestaña "Formulario".
    ...
    <div class="flex-col flex-grow">
    	[email* your-email placeholder "Tu mensaje (requerido)"]
    </div>
    <div class="flex-col ml-half">
    	[submit class:button primary "Regístrate"]
    </div>
    </div>
    </textarea>
    ...
    <textarea style="width:100%;min-height: 100px;">
    <div class="form-flat">
      [email* your-email placeholder "tu E-mail (requerido)"]
      [submit class:button primary "Regístrate"]
    </div>
    </textarea>
