<header class="archive-page-header">
	...
	<h1 class="page-title is-large uppercase">
		<?php
			...
			if ( is_category() ) :
				printf( __( 'Categoría: %s', 'flatsome' ), '<span>' . single_cat_title( '', false ) . '</span>' );

			elseif ( is_tag() ) :
				printf( __( 'Etiqueta: %s', 'flatsome' ), '<span>' . single_tag_title( '', false ) . '</span>' );

			elseif ( is_search() ) :
				printf( __( 'Buscar resultados por: %s', 'flatsome' ), '<span>' . get_search_query() . '</span>' );
